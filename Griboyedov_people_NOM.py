...
for line in people:
    line = re.sub(u'ъ(\\s|;)', u'\\1', line, flags=re.U)
    line = re.sub(u'ѣ', u'е', line, flags=re.U)
    ...
    line = re.sub(u'(ая)\\s(\\w+)(ч|в|с)(у|а)(;|\\s)', u'ай \\2\\3\\5', line, flags=re.U) #Николая Николавевича
    line = re.sub(u'(а|у)\\s(\\w+)(ч|в|с)(у|а)(;|\\s)', u' \\2\\3\\5', line, flags=re.U)
